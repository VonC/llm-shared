...
the title names the one project or the project count, and that no my-project
...
class TestRendering:
    ...
    def test_render_drops_the_my_project_strings(self) -> None:
        """The real bundled template renders with no my-project string or token."""
        data = aggregate.aggregate(SAMPLE_COMMITS)
