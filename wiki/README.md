...
shared trail, or 🤖 llm-shared as a whole when the page spans them all.
The image-generation prompts behind the five theme logos are kept in
[assets/logo-prompts.md](assets/logo-prompts.md).

Documentation for [llm-shared](../README.md), organized on the
...
what you see. Start here if llm-shared is new to you.
...
Background and reasoning: why llm-shared is built the way it is.
