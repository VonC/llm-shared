...
You must separate properly with empty lines each code block with empty lines before writing the next block (preceded with Files, as instructed in `CLAUDE.md`).
