...
user-invocable: true
argument-hint: 'Give the start date and the working trees, for example "activity-report --start 2026-05-29 . ../pdfsplitter". End date defaults to today (--end YYYY-MM-DD). Optionally pass an existing report file to update it; with no file the conventional a.activity-report.<start>-<end>.md is created, or updated when it already exists.'
---
