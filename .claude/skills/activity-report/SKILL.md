...
user-invocable: true
argument-hint: 'Give the start date and the working trees, for example "activity-report --start 2026-05-29 . ../my-project". End date defaults to today; override with --end YYYY-MM-DD.'
---
