...
For the second implementation plan document, follow the template from [`plan.implementation.template.md`](./plan.implementation.template.md) to write the implementation plan document, and adapt it as needed if some sections are not relevant for the specific design you are writing.
