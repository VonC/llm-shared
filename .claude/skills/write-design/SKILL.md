...
Follow the template from [`design.template.md`](./design.template.md) to write the design document, and adapt it as needed if some sections are not relevant for the specific design you are writing.
...
- Do not add the open-questions section in this skill output; It will be addressed by [`review-ask-questions/SKILL.md`](../review-ask-questions/SKILL.md) in a later follow-up review step.
