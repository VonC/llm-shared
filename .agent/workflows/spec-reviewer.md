---
description: Assess specification questions and publish independent feedback through the shared exchange.
---

1. Locate the shared instruction body `instructions/spec-reviewer.md`: in this
