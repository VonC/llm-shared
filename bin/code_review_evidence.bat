...
REM Wrapper for tools\code_review_evidence_cli.py. Self-locates llm-shared and
REM runs its newest matching virtual-environment Python without activation.
...
"%PYTHON_EXE%" "%LLM_SHARED_DIR%\tools\code_review_evidence_cli.py" %*
