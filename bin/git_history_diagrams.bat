...
REM Self-locating launcher for the Git-history SVG diagram generator.
...
"%PYTHON_EXE%" "%LLM_SHARED_DIR%\tools\git_history_diagrams\generate_git_history_diagrams.py" %*
