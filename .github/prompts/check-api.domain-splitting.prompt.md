...
You write a markdown document, so respect instructions for markdown lists in #file:../../rules/markdown.md : only one space in a list item: `- item 1` not `-   item 2` or `-  item 3`, `1. item 1` not `1.   item 2` or `1.  **item 3**`, etc.
