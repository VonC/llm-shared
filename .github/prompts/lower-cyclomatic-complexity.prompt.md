...
Read your instructions in `.github\copilot-instructions.md` ( #file:../copilot-instructions.md ) and `.github\python.instructions.md` ( #file:../python.instructions.md ). Avoid `Type of "xxx" is partially unknown`: every type must be fully typed. Read and follow instructions from #file:../../rules/preserve_code.md .
