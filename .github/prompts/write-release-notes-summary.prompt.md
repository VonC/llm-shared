...
You will derive those goals from the list (present in your prompt or your context) of conventional commits subjects (composed of a type and a scope between '`*(scope)*`', followed by a colon, followed by a description).
...
Separate each sections with an empty line.  
