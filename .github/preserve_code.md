...
- preserve all relevant comments, any small inline comments like `// Act`, `// Assert`, `// TODO`, or  `# Act`, `# Assert`, `# Make ...`, etc: all MUST be preserved, unless they are no longer relevant in the current rewrite.
