...
metadata:
  ...
  - "The argument hint for this skill is 'Provide all three inputs: the type (feature-request or issue), the product version as vX.Y.Z, and a topic label for the specific feature or area of concern using only lowercase letters, digits, hyphens, and underscores, for example "issue v9.3.0 sentinels".'."
argument-hint: 'Provide all three inputs: the type (feature-request or issue), the product version as vX.Y.Z, and a topic label for the specific feature or area of concern using only lowercase letters, digits, hyphens, and underscores, for example "issue v9.3.0 sentinels".'
---
