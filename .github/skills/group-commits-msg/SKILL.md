...
user-invocable: true
metadata: 
  - "This skill is used to group files and write a conventional commit message for each group in the project-root `a.commit` (`%PRJ_DIR%\\a.commit`, never under `docs/` or any subfolder)."
