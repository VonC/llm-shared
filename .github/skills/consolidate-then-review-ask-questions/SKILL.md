...
metadata:
  ...
  - "The argument hint for this skill is 'Provide the type, version and topic of the document (feature-request, issue, design or implementation plan), for example "design v9.3.0 sentinels".'"
argument-hint: 'Provide the type, version and topic of the document (feature-request, issue, design or implementation plan), for example "design v9.3.0 sentinels".'
---
